...
class CarRentalSystem:
    ...
    def make_booking(self, customer, period, car, location):
        ...
        try:
            ...
            elif not location.pickup or not location.dropoff:
                if not location.pickup:
                    raise BookingError("location", "Specify a valid start location")
                else:
                  raise BookingError("location", "Specify a valid end location")
        except BookingError:
            raise
